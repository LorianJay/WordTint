...
//        DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff(new BookDiffCallback(this.wordBookSectionEntityList, new ArrayList<>(newData)));
...
//        for (WordBookSectionVO wordBookSectionVO : wordBookSectionEntityList) {
