...
//        // 设置监听事件
//        bindListener();
//        this.chineseAnswerHandler = new ChineseAnswerHandler(null,null);
...
//        this.userRecitePreference = userCreditStyleWrapper.getUserCreditStyle();
...
//                if (userRecitePreference.getCreditOrder() == ReciteOrder.DISORDER) {
//                    Collections.shuffle(allFunctionWordList);
//                } else if (userRecitePreference.getCreditOrder() == ReciteOrder.LEXICOGRAPHIC) {
//                }
//                if (userRecitePreference.getCreditFilter() == ReciteFilter.PHRASE) {
//                    // todo 只背介词
...
//                this.wordFunctionHandler.setCurrentCreditState(userRecitePreference.getCreditMode());
//            }
