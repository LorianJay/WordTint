...
public class MockExamineFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int itemId = v.getId();
        // 非模拟
        if (itemId == R.id.fragment_mock_examine_interrupt) {
            isRunning = !isRunning;
            if (isRunning) {
                recordTimeStamp = System.currentTimeMillis();
            }
            return;
        } else if (itemId == R.id.fragment_mock_examine_background) {
            invisibleButton(View.VISIBLE);
            remainFadeButtonTime = 1000 * 5;
            return;
        } else if (itemId == R.id.fragment_mock_examine_exit) {
            ...
            return;
        } else if (itemId == R.id.fragment_mock_examine_remove_5) {
            remainTime += 1000 * 5;
            alreadyTime -= 1000 * 5;
            return;
        } else if (itemId == R.id.fragment_mock_examine_add_5) {
            remainTime -= 1000 * 5;
            alreadyTime += 1000 * 5;
            return;
        } else if (itemId == R.id.fragment_mock_examine_remove_30) {
            remainTime += 1000 * 30;
            alreadyTime -= 1000 * 30;
            return;
        } else if (itemId == R.id.fragment_mock_examine_add_30) {
            remainTime -= 1000 * 30;
            alreadyTime += 1000 * 30;
            return;
        }
        if (itemId == R.id.fragment_mock_examine_politician ||
                itemId == R.id.fragment_mock_examine_math) {
            alreadyTime = 1000 * 60 * 60 * 8;
        } else if (itemId == R.id.fragment_mock_examine_english ||
                itemId == R.id.fragment_mock_examine_major) {
    ...
    private void bindView() {
        ...
        this.mockPolitician = rootView.findViewById(R.id.fragment_mock_examine_politician);
        this.mockEnglish = rootView.findViewById(R.id.fragment_mock_examine_english);
        this.mockMath = rootView.findViewById(R.id.fragment_mock_examine_math);
        this.mockMajor = rootView.findViewById(R.id.fragment_mock_examine_major);
        this.topTime = rootView.findViewById(R.id.fragment_mock_examine_top_time);
        this.subTopTime = rootView.findViewById(R.id.fragment_mock_examine_sub_top_time);
        this.bottomTime = rootView.findViewById(R.id.fragment_mock_examine_bottom_time);
        this.subBottomTime = rootView.findViewById(R.id.fragment_mock_examine_sub_bottom_time);
        this.backGround = rootView.findViewById(R.id.fragment_mock_examine_background);
        this.interrupt = rootView.findViewById(R.id.fragment_mock_examine_interrupt);
        this.exit = rootView.findViewById(R.id.fragment_mock_examine_exit);
        this.remove5s = rootView.findViewById(R.id.fragment_mock_examine_remove_5);
        this.add5s = rootView.findViewById(R.id.fragment_mock_examine_add_5);
        this.remove30s = rootView.findViewById(R.id.fragment_mock_examine_remove_30);
        this.add30s = rootView.findViewById(R.id.fragment_mock_examine_add_30);
    }
